/*
** $Id: newgal.h,v 1.19 2004/02/25 02:34:50 weiym Exp $
** 
...
** and having the same license with MiniGUI.
** 
 ...
 */
extern int GAL_SetGamma (float red, float green, float blue);
 ...
 */
extern int GAL_SetGammaRamp (Uint16 *red, Uint16 *green, Uint16 *blue);
 ...
 * this function will return -1.
 */
extern int GAL_GetGammaRamp (Uint16 *red, Uint16 *green, Uint16 *blue);
#endif
...
*/
extern GAL_Overlay *GAL_CreateYUVOverlay (int width, int height,
                Uint32 format, GAL_Surface *display);

#if 0
/* Lock an overlay for direct access, and unlock it when you are done */
extern int GAL_LockYUVOverlay (GAL_Overlay *overlay);
extern void GAL_UnlockYUVOverlay (GAL_Overlay *overlay);

/* Free a video overlay */
extern void GAL_FreeYUVOverlay (GAL_Overlay *overlay);
#endif
...
*/
extern int GAL_DisplayYUVOverlay (GAL_Overlay *overlay, GAL_Rect *dstrect);
...
extern int InitGAL (void);
#define TerminateGAL GAL_VideoQuit
