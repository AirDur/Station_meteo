...
** 
** 2003/07/10: Create by Wei Yongming.
*/
...
#define SHIFT(x) ((x&1)?0:4)
static unsigned char pixmask [] = {0xf0, 0x0f};
static unsigned char pixnotmask [] = {0x0f, 0xf0};
...
static unsigned char right_side_mask [] = {0xff, 0x0f};
static unsigned char left_side_mask [] = {0x00, 0xf0};
static unsigned char right_ban_mask [] = {0x00, 0x0f};
static unsigned char left_ban_mask [] = {0x00, 0xf0};
