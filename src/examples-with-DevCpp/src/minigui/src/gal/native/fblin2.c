...
#define SHIFT(x) ((x & 3) << 1)
static unsigned char pixmask [] = {0x03, 0x0c, 0x30, 0xc0};
static unsigned char pixnotmask [] = {0xfc, 0xf3, 0xcf, 0x3f};
...
static unsigned char right_side_mask [] = {0xff,0xfc,0xf0,0xc0};
static unsigned char left_side_mask [] = {0x00,0x03,0x0f,0x3f};
