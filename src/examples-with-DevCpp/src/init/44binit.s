...
# *******************************************************
    ...
    .include "src/init/option.a"
    .include "src/init/memcfg.a"
...
F0:
    ...
    BCC	    F0
F1:
    LDR	    r1, =Image_ZI_Base		/* Top of zero init segment */
    MOV	    r2, #0
F2:
    CMP	    r3, r1	    		/* Zero init */
    STRCC   r2, [r3], #4
...
#bank7	16bit SDRAM
.ifeq BUSWIDTH-16
	.long 0x01001102	/* Bank0=16bit BootRom(AT29C010A*2) :0x0 */
.else
...
.equ 	UserStack,	_ISR_STARTADDRESS-0x500    		/* c1(c7)ffa00 */   	
.equ	SVCStack,	_ISR_STARTADDRESS-0x500+256    	/* c1(c7)ffb00 */
.equ	UndefStack,	_ISR_STARTADDRESS-0x500+256*2   /* c1(c7)ffc00 */
.equ	AbortStack,	_ISR_STARTADDRESS-0x500+256*3   /* c1(c7)ffd00 */
.equ	IRQStack,	_ISR_STARTADDRESS-0x500+256*4   /* c1(c7)ffe00 */
.equ	FIQStack,	_ISR_STARTADDRESS-0x500+256*5   /* c1(c7)fff00 */
