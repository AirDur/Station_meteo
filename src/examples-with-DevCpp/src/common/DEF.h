...
#define	outportb(data, port)	(*(volatile U8 *)(port) = (data))
#define	outportw(data, port)	(*(volatile U16 *)(port) = (data))
#define	outportl(data, port)	(*(volatile U32 *)(port) = (data))
#define	inportb(port)			*(volatile U8 *)(port)
#define	inportw(port)			*(volatile U16 *)(port)
#define	inportl(port)			*(volatile U32 *)(port)
