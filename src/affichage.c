...
w = GrNewWindow(1, 10, 50, 130, 250, 5, BLACK, WHITE);
GrMapWindow(w);
...
GrText(w, gc, 15, 20,"en temps reel", 16, GR_TFASCII);
...
GrText(w, gc, 0, 170," - Humidite :", 14, GR_TFASCII);
GrText(w, gc, 0, 190,sH, 12, GR_TFASCII);
GrLine(w, gc, 0, 210, 120, 210);
