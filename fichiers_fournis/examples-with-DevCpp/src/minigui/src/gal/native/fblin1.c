...
**
** Original author: Wang Jianwei, derived from fblin2.c.
** Rewritten by Feynman Software.
**
** Copyright (C) 2003 Feynman Software.
** Copyright (C) 2002 Wang Jianwei.
**
** 2002/01/13: Create by Wang Jianwei.
...
#define SHIFT(x) (x&7)
static unsigned char pixmask [] = {0x01,0x02,0x04,0x08,0x10,0x20,0x40,0x80};
static unsigned char pixnotmask [] = {0xfe,0xfd,0xfb,0xf7,0xef,0xdf,0xbf,0x7f};

#define normalize_pixel(c) (c & 0x01)
...
static unsigned char right_side_mask [] = {0xff,0xfe,0xfc,0xf8,0xf0,0xe0,0xc0,0x80};
static unsigned char left_side_mask [] = {0x00,0x01,0x03,0x07,0x0f,0x1f,0x3f,0x7f};
static unsigned char right_ban_mask [] = {0x00,0x80,0xc0,0xe0,0xf0,0xf8,0xfc,0xfe,0xff};
static unsigned char left_ban_mask [] = {0x00,0x01,0x03,0x07,0x0f,0x1f,0x3f,0x7f,0xff};
